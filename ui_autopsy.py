...
with clips_tab:
    ...
    if not analysis:
        ...
        use_ai = col2.checkbox("Analyze with TwelveLabs → Neo4j", value=True,
                               help="TwelveLabs watches each clip, its verdict is written to the "
                                    "graph, and the Strands agent can then reason over it.")
